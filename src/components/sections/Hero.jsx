        ...
        <Container className="relative z-20 flex h-full flex-col items-center justify-center pb-10 pt-24 text-center sm:pb-12 sm:pt-28 lg:pb-14 lg:pt-32">
          ...
          >
            <DistortedText
              as="p"
              intensity="subtle"
              className="font-mono text-[11px] uppercase tracking-[0.28em] text-brand-mist/60"
            >
            ...
            <DistortedText
              as="p"
              intensity="medium"
              className="mx-auto mt-9 max-w-3xl text-base leading-8 tracking-[0.12em] text-brand-mist sm:text-lg sm:leading-9"
            >
