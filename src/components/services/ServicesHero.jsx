...
function HeroRings({ reduce }) {
  return (
    ...
    >
      ...
      <circle cx="200" cy="200" r="3" fill="#00C853" stroke="none" />
...
export function ServicesHero() {
  ...
  return (
    ...
    >
      {/* Teknisk bakgrund: nodgrid, ringar och animerat brus. */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_-10%,rgba(255,255,255,0.04),transparent_40%),radial-gradient(circle_at_8%_30%,rgba(255,255,255,0.018),transparent_30%)]" />
      ...
      <Container className="relative">
        <motion.p
          ...
          className="flex items-center gap-2.5 font-mono text-[11px] uppercase tracking-[0.34em] text-brand-green"
        >
        ...
        >
          ...
          <span className="text-brand-green">connected environment.</span>
        </motion.h1>
