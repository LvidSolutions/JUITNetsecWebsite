...
/**
 * Kontaktformulär i mörk, premium-stil. Behåller JUIT-strukturen:
 * Namn, Företag, E-post, Telefon, Typ av behov, Meddelande.
 */
          ...
          <div>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div>
                ...
                <p className="mt-2 font-display text-lg font-medium text-brand-white">+46 70 000 00 00</p>
              </div>
            </div>
          </div>
